...
M.polish_hl = vim.tbl_deep_extend("force", M.polish_hl or {}, {
  ...
  statusline = {
    St_NormalMode = { bg = M.base_30.nord_blue, fg = M.base_30.black, bold = true },
    St_InsertMode = { bg = M.base_30.green1, fg = M.base_30.black, bold = true },
    St_VisualMode = { bg = M.base_30.purple, fg = M.base_30.black, bold = true },
    St_ReplaceMode = { bg = M.base_30.orange, fg = M.base_30.black, bold = true },
    St_CommandMode = { bg = M.base_30.yellow, fg = M.base_30.black, bold = true },
    St_TerminalMode = { bg = M.base_30.teal, fg = M.base_30.black, bold = true },
    St_NTerminalMode = { bg = M.base_30.teal, fg = M.base_30.black, bold = true },
    St_SelectMode = { bg = M.base_30.pink, fg = M.base_30.black, bold = true },
    St_ConfirmMode = { bg = M.base_30.yellow, fg = M.base_30.black, bold = true },
    St_NormalModeSep = { fg = M.base_30.nord_blue, bg = M.base_30.black },
    St_InsertModeSep = { fg = M.base_30.green1, bg = M.base_30.black },
    St_VisualModeSep = { fg = M.base_30.purple, bg = M.base_30.black },
    St_ReplaceModeSep = { fg = M.base_30.orange, bg = M.base_30.black },
    St_CommandModeSep = { fg = M.base_30.yellow, bg = M.base_30.black },
    St_TerminalModeSep = { fg = M.base_30.teal, bg = M.base_30.black },
    St_NTerminalModeSep = { fg = M.base_30.teal, bg = M.base_30.black },
    St_SelectModeSep = { fg = M.base_30.pink, bg = M.base_30.black },
    St_ConfirmModeSep = { fg = M.base_30.yellow, bg = M.base_30.black },
    St_file = { bg = M.base_30.black2, fg = M.base_30.white },
    St_file_sep = { fg = M.base_30.black2, bg = M.base_30.black },
